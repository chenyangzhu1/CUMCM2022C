...
param_bounds=([-np.inf,-np.inf,-np.inf,-np.inf,-np.inf,-np.inf,-np.inf,-np.inf,-np.inf,-np.inf,-np.inf,-np.inf],[np.inf,np.inf,np.inf,-2,-2,np.inf,np.inf,np.inf,np.inf,np.inf,np.inf,np.inf])#设定B和n的下界和上界。其中B为负无穷到正无穷，n为0到1
...
np.savetxt("高钾氧化铁预测.csv",ans,delimiter=',')
